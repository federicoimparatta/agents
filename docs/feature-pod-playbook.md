...
four-agent pod. Instead of marching through rigid day-by-day schedules, the team
...
strategic framing, experience definition, technical planning, and operations
coordination progress as a single flow.
...
- **Key outputs:** Prototype or narrative walkthrough, technical approach,
  measurement plan, updated decision log.
...
- **Key outputs:** Launch kit, enablement briefing, monitoring dashboards,
  support playbook, go/no-go decision record.
